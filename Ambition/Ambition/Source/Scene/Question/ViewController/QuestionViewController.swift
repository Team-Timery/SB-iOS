...
class QuestionViewController: UIViewController {
    ...
    private let getFAQRelay = PublishRelay<Void>()
    private var faqData: FAQListEntity = [] {
        didSet { questionTableView.reloadData() }
    }
    ...
    lazy var input = FAQViewModel.Input(getData: getFAQRelay.asSignal())
...
extension QuestionViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.titleLabel.text = faqData[indexPath.row].title
        cell.contentLabel.text = faqData[indexPath.row].content
